...
public class ManageOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableCustomer.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 17)); // NOI18N
        tableCustomer.setForeground(new java.awt.Color(68, 0, 0));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 413, 154));
        ...
        tableProduct.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 17)); // NOI18N
        tableProduct.setForeground(new java.awt.Color(68, 0, 0));
        ...
        if (tableProduct.getColumnModel().getColumnCount() > 0) {
            tableProduct.getColumnModel().getColumn(6).setHeaderValue("Category Name");
        }

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 130, 383, 154));

        tableCart.setFont(new java.awt.Font("Tw Cen MT Condensed", 1, 17)); // NOI18N
        tableCart.setForeground(new java.awt.Color(68, 0, 0));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 130, 365, 154));

        jLabel4.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(68, 0, 0));
        jLabel4.setText("Cart");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 100, -1, -1));
        ...
        txtCustomerName.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        txtCustomerName.setForeground(new java.awt.Color(68, 0, 0));
        txtCustomerName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCustomerNameActionPerformed(evt);
            }
        });
        getContentPane().add(txtCustomerName, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 390, 413, -1));
        ...
        txtCustomerMobileNumber.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        getContentPane().add(txtCustomerMobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 460, 413, -1));

        jLabel8.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(68, 0, 0));
        jLabel8.setText("Email");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 500, -1, -1));

        txtCustomerEmail.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        txtCustomerEmail.setForeground(new java.awt.Color(68, 0, 0));
        getContentPane().add(txtCustomerEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 530, 413, -1));

        jLabel9.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(68, 0, 0));
        jLabel9.setText("Selected Product:");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 320, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(68, 0, 0));
        jLabel10.setText("Product Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 360, -1, -1));

        txtProductName.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        txtProductName.setForeground(new java.awt.Color(68, 0, 0));
        txtProductName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtProductNameActionPerformed(evt);
            }
        });
        getContentPane().add(txtProductName, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 390, 383, -1));

        jLabel11.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(68, 0, 0));
        jLabel11.setText("Product Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 430, -1, -1));

        txtProductPrice.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        txtProductPrice.setForeground(new java.awt.Color(68, 0, 0));
        getContentPane().add(txtProductPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 460, 383, -1));

        jLabel12.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(68, 0, 0));
        jLabel12.setText("Product Description");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 500, -1, -1));

        txtOrderQuantity.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        txtOrderQuantity.setForeground(new java.awt.Color(68, 0, 0));
        getContentPane().add(txtOrderQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 590, 383, -1));

        jLabel13.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(68, 0, 0));
        jLabel13.setText("Order Quantity");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 570, -1, -1));

        txtProductDescription.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        txtProductDescription.setForeground(new java.awt.Color(68, 0, 0));
        txtProductDescription.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtProductDescriptionActionPerformed(evt);
            }
        });
        getContentPane().add(txtProductDescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 530, 383, -1));

        jButton1.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jButton1.setForeground(new java.awt.Color(181, 181, 46));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 630, 120, 70));

        jLabel14.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 20)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(68, 0, 0));
        jLabel14.setText("Total Amount:");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 310, -1, -1));

        lblFinalTotalPrice.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 20)); // NOI18N
        lblFinalTotalPrice.setForeground(new java.awt.Color(68, 0, 0));
        lblFinalTotalPrice.setText("00000");
        getContentPane().add(lblFinalTotalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 310, -1, -1));

        btnSaveOrderDetails.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        btnSaveOrderDetails.setForeground(new java.awt.Color(45, 156, 82));
        btnSaveOrderDetails.setText("Save Order");
        btnSaveOrderDetails.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSaveOrderDetailsActionPerformed(evt);
            }
        });
        getContentPane().add(btnSaveOrderDetails, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 460, 120, 70));

        jButton3.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jButton3.setForeground(new java.awt.Color(158, 62, 126));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 380, 120, 70));

        jButton4.setFont(new java.awt.Font("Tw Cen MT", 1, 17)); // NOI18N
        jButton4.setForeground(new java.awt.Color(213, 78, 78));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 540, 120, 70));
    ...
    private void btnSaveOrderDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveOrderDetailsActionPerformed
        ...
        if (finalTotalPrice != 0 && !txtCustomerName.getText().equals("")) {
            ...
            try {
                ...
                BaseColor backgroundColor = new BaseColor(37, 150, 190);
                ...
                doc.add(tbl);
                doc.add(starLine);
                Paragraph thanksMsg = new Paragraph("                           Thank you for purchasing at Konica Balayan! Please visit again.");
                doc.add(thanksMsg);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!noOfUnits.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Number of quantity & product field is required.");
        }
