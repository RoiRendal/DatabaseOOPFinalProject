...
//            st.executeUpdate("insert into appuser (userRole, name, mobileNumber,email,password,address,status) values('SuperAdmin', 'Super Admin', '09175551234', 'superadmin@testemail.com', 'konica', 'Philippines', 'Active')");
...
//            st.executeUpdate("drop table appuser");
//            st.executeUpdate("drop table category");
//            st.executeUpdate("drop table product");
//            st.executeUpdate("drop table customer");
//            st.executeUpdate("drop table orderDetail");

//            st.executeUpdate("DELETE FROM appuser WHERE name='Eliong Balagtas'");
